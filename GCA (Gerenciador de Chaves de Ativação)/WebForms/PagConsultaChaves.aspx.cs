...
namespace GCA__Gerenciador_de_Chaves_de_Ativação_.WebForms
{
    public partial class PagConsultaChaves : System.Web.UI.Page
    {
        ...
        {
            GridConsultaChaveAtivacao.DataSource = Framework.GetDataTable("SELECT tb_Software.ID_Software, tb_Software.NomeDoSoftware, tb_Software.TipoDeSoftware, tb_Software.PrazoLicenca, tb_Software.Idioma, tb_Software.Sistema, tb_Software.Fabricante, tb_Software.Versao, tb_Software.ChaveDeAtivacao, tb_Software.Status, tb_Maquina.ID_Maquina, tb_Maquina.NomeMaquina, tb_Maquina.SistemaOperacional, tb_Maquina.Processador, tb_Maquina.MemoriaRam, tb_Maquina.Armazenamento, tb_Maquina.Status, tb_Usuario.ID_Usuario, tb_Usuario.NomeUsuario, tb_Usuario.Funcao, tb_Usuario.Setor FROM tb_Software INNER JOIN tb_Maquina ON tb_Software.ID_Software = tb_Maquina.ID_Software INNER JOIN tb_Usuario ON tb_Maquina.ID_Usuario = tb_Usuario.ID_Usuario");
